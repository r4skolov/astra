...
const yt = /* @__PURE__ */ (/* unused pure expression or super */ null && ((() => ({
  [mt]: {
    O: (t, n, o) => {
...
const Ot = /* @__PURE__ */ (/* unused pure expression or super */ null && ((() => ({
  [Ct]: {
    T: t => {
      const {I: n, A: o, L: s} = t;
      const e = !s && !n && (o.x || o.y);
...
const Tt = /* @__PURE__ */ (/* unused pure expression or super */ null && ((() => ({
  [zt]: {
    O: (t, n, o, s, e) => {
      let c = 0;
      let r = noop;
...
;// CONCATENATED MODULE: ./source/js/scrollbar.js
// import Scrollbar from 'smooth-scrollbar';
//
// Scrollbar.init(document.querySelector('#my-scrollbar'));


const osInstance = OverlayScrollbars(document.querySelector('.scroll'), {
  overflow: {
    x: 'hidden'
  }
});
const ratesScroll = document.querySelector('.scroll-rates');
if (ratesScroll) {
